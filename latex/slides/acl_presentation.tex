...
\begin{frame}{Tier 1: a stable-looking score can be a property of the probe}
  \begin{columns}[T,onlytextwidth]
    ...
    \column{0.49\textwidth}
      \resizebox{\linewidth}{!}{\begin{tikzpicture}[x=0.045cm,y=1cm]
...
\begin{frame}{Matched comparison: the tested axis accounts for 11$\times$ more variation}
  \begin{columns}[c,onlytextwidth]
    \column{0.47\textwidth}
      \resizebox{\linewidth}{!}{\begin{tikzpicture}[x=60cm,y=1cm]
...
\begin{frame}{The metric leads directly to a better intervention}
  \begin{columns}[c,onlytextwidth]
    \column{0.48\textwidth}
      \resizebox{\linewidth}{!}{\begin{tikzpicture}[x=0.043cm,y=1cm]
...
\begin{frame}{Take-home message}
  ...
  \end{columns}
  \vfill
  {\centering\small\color{muted}Questions? \quad Project page: \url{https://technoob05.github.io/llm-behavior-validity-survey/}\par}
\end{frame}
